...
\qitem{Os indivíduos tornam-se \textit{dividuais}, divisíveis, e as massas
tornaram-se amostras, dados, mercados ou \textit{bancos}.}{\textsc{gilles deleuze},\\\textit{Post-scriptum sobre as sociedades de controle}}
\bigskip
\qitem{Sublinhou-se recentemente a que ponto o exercício do poder moderno não
se reduzia à alternativa clássica \textit{repressão ou ideologia}, mas
...
movimento, etc, e que passam por microagenciamentos.}{\textsc{gilles deleuze \& félix guattari},\\\emph{Mil platôs: capitalismo e esquizofrenia, vol.\,5}}
\bigskip
\qitem{A expressão e a efetuação dos mundos e das subjetividades neles
...
\chapterspecial{Introdução}{A modulação de opiniões\\e comportamentos}{}
\markboth{Introdução}{}


\begin{flushright}
\textsc{joyce souza, rodolfo avelino e\\sergio amadeu da silveira}
\end{flushright}
...
jornada. No segundo capítulo, o professor Sergio Amadeu da Silveira vai

...
\begin{epigraphs} 
\qitem{Quem controla o passado, controla o futuro. Quem~controla~o~presente,~controla~o~passado.}
{\textit{1984}\\\textsc{george orwell}}

\medskip

\qitem{Já deixamos a era da disciplina para entrar no tempo do controle.}
...
\section{modulação e manipulação}
...
\chapter*{A noção de modulação e os\break sistemas algorítmicos\footnote{Este texto é fruto das reflexões originadas na pesquisa ``A regulação algorítmica do setor público: mapeamento teórico-programático'', processo 2017/14412-0, apoiada pela Fundação de Amparo à Pesquisa do Estado de São Paulo (\textsc{fapesp}). As opiniões, hipóteses e conclusões ou recomendações expressas neste material são de responsabilidade do autor e não necessariamente refletem a visão da \textsc{fapesp}.}}
\addcontentsline{toc}{chapter}{A noção de modulação e os sistemas algorítmicos}
...
Data}. Os sistemas algorítmicos modelados como \textit{aprendizado de máquina}
...
vez mais as pessoas para melhor atendê"-las e \textit{fidelizá"-las}. A munição
...
% \caption{\formular\footnotesize{Kit de ferramentas de \textit{aprendizado de máquina} do Facebook.\protect\footnotemark}}
% \end{figure}
...
Instrumentos como Facebook, entre outros \textit{websites}, são capazes de
...
\chapterspecial{Existe resistência nas sociedades de controle?}{A reação social diante da apropriação\break da rede pela lógica do capital}{}

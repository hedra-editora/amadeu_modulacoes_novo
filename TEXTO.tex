...
\tit{SILVEIRA}, Sergio Amadeu da. \emph{Tudo sobre tod@s: Redes digitais,
...
\textls[-10]{A popularização e a queda dos preços dos \emph{smartphones} e a expansão das
...
<<<<<<< HEAD
bi. Esse número representa 26\% do \textsc{pib} brasileiro no mesmo período, \textsc{us}\$ 1,796 trilhão.\footnote{Informações obtidas no relatório de 2016
  da Statista, disponível em hedra.com.br/r/Fp5.}
=======
...
do século \textsc{xxi}.\footnote{Sergio Amadeu da Silveira. \emph{Tudo sobre tod@ s: Redes digitais, privacidade e venda de dados pessoais}. São Paulo: Edições Sesc, 2017.} A limitação desse mercado só pode ser
...
\textls[-10]{As principais plataformas de relacionamento \emph{online} não produzem
...
<<<<<<< HEAD
  (\textsc{us9928462b2}), tradução livre.} 
=======
  (\textsc{us--9928462b2}).} 
>>>>>>> d5ddff317e5c25b95381e05b265116f9f5053bc2
\end{quote}
...
Segundo Biddle, o ``\emph{\textsc{fbl}earner Flow}'' foi declarado como
...
\footnotetext{Fonte: Facebook. \mbox{\textless{}\emph{https://www.hedra.com.br/r/7d6}\textgreater{}.}}
...
%Alguns exemplos podem ser vistos no \emph{print} a seguir:

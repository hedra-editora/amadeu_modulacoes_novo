...
\begin{itemize}
\item[]\textsc{us9928462b2} -- Apparatus and method for determining user's mental state.

\item[]\textsc{us-2010088607-a1} -- System and method for maintaining context sensitive
user

\item[]\textsc{us-2012272338-a1} -- Unified tracking data management

\item[]\textsc{us-2012226748-a1} -- Identify Experts and Influencers in a Social Network

\item[]\textsc{us2018019226-3a1} -- Predicting the future state of a mobile device user

\item[]\textsc{us20080033826-a1} -- Personality-based and mood-base provisioning of
advertisements
\end{itemize}

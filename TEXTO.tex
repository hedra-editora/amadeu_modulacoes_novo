...
superabundância de fontes de informação que poderiam consumi"-la''.\footnote{``Designing Organizations for an Information-Rich World'', pp.\,40--41. \textit{In}: M. Greenberger (Ed.). \textit{Computers, communications, and the public interest}. Baltimore, \textsc{md}: The Johns Hopkins Press, 1971.} Tal pensamento estimularia que vários pensadores,
...
\tit{BARROS FILHO}, Clóvis de. \textit{Agenda setting e educação}. \textit{In}:
Comunicação e Educação -- Revista do Departamento de Comunicações e
Artes da \textsc{eca}/\textsc{usp}. São Paulo, 1996, pp.\,27 a 33. Disponível em \textit{hedra.com.br/r/wHi}.

\tit{BASTA}, D.; \textsc{marchesi}, F. R. de A.; \textsc{oliveira}, J. A. F. de; \textsc{sá}, L. C. S. de. \textit{Fundamentos de Marketing} -- 7ª Edição. Série Gestão
Empresarial. Rio de Janeiro. Editora \textsc{fgv}, 2006.

\tit{CASTELLS}, Manuel. \textit{O Poder da Comunicação}, pp.\,209--210. 2ª
...
\textit{Debate Collor x Lula.} \textit{In}: Memória Globo. Online. Disponível em \textit{hedra.com.br/r/fRQ}.

\tit{FOUCAULT}, Michel . \textit{Microfísica do poder.} 8ª. ed. Rio de
Janeiro: Graal, 1989.

\tit{GREGÓRIO}, Rafael. \textit{Omo, Coca-Cola, Nike e Samsung são as marcas
...
\tit{KOTLER}, P.; \textsc{keller}, Kevin L. \textit{Administração de marketing.} 14.
ed. São Paulo: Pearson Prentice Hall, 2013.

\tit{LAZZARATO}, Maurizio. \textit{As revoluções do capitalismo.} Civilização
Brasileira, 2006.

\titidem. \textit{Signos, máquinas e subjetividades.} São
Paulo: Edições \textsc{sesc-sp}: n-1 edições, 2014.

\tit{LIMA}, M.; \textsc{sapiro}, A.; \textsc{vilhena}, J.B.; \textsc{gangana}, M. \textit{Gestão de Marketing} --- 8ª edição revista e atualizada. Rio de Janeiro: Editora
\textsc{fgv}, 2007.

\tit{MCINTYRE}, Ewan; \textsc{virzi}, Anna Maria. \textit{\textsc{cmo} Spend Survey 2017--2018:
...
Information-Rich World'', pp.\,40--41. \textit{In}: M. Greenberger (Ed.). \textit{Computers,
...
como elas ocorreram e quem as realizou.\footnote{Nick Srnicek. \textit{Platform capitalism}. Nova Jersey: John Wiley \& Sons, 2017.} O \textit{Big Data},
...
do século \textsc{xxi}.\footnote{Sergio Amadeu da Silveira. \textit{Tudo sobre tod@ s: Redes digitais, privacidade e venda de dados pessoais}. São Paulo: Edições Sesc, 2017.} A limitação desse mercado só pode ser
...
\begin{bibliohedra}
\tit{CASTELLS}, Manuel. \textit{Power communication.} New York: Ed. Oxford,
2009.

\tit{DEFLEUR}, Melvin. \textit{Teorias da comunicação de massa}. Zahar, 1993.

\tit{DELEUZE}, Gilles. \textit{Post-Scriptum Sobre as Sociedades de Controle}. \textit{In}:
\textsc{deleuze}, Gilles. \textit{Conversações}. Trad. Peter Pál Pelbart. São Paulo:
...
\tit{SIMONDON}, Gilbert. \textit{On the mode of existence of technical
objects}. Deleuze Studies, v.\,5, n.\,3, p.\,407--424, 2011.

\tit{SRNICEK}, Nick. \textit{Platform capitalism}. John Wiley \& Sons, 2017.
...
Uma das maiores mudanças que a Sociedade em Rede\footnote{Manuel Castells. \textit{A sociedade em rede}. São Paulo: Paz e Terra, 2007.}
...
análise dos 10 anos do feed de notícias}, 2017.} %(\textsc{jurno}, 2015)
...
\begin{bibliohedra}
\tit{abbas}, A.; \textsc{zhang}, L.; \textsc{khan}, S. U. \textit{A literature review on the
state"-of"-the"-art in patent analysis}. World Patent Information, 06/2014. v.\,37, p.\,3--13.

\tit{agarwal}, n.\,\textit{Quantifying Social Influence}. Disponível em \textit{hedra.com.br/r/Gkj}.

\tit{araújo}, W. F. \textit{As narrativas sobre os algoritmos do Facebook: uma
...
\tit{booth}, R. \textit{Facebook reveals news feed experiment to control
emotions}. The Guardian, 06/2014. Disponível em \textit{hedra.com.br/r/mzU}.

\tit{bruno}, F. \textit{Rastros digitais sob a perspectiva da teoria
...
\tit{caliskan}, A. \textit{et al.} \textit{Semantics derived automatically from
language corpora contain human-like biases}. Science, 04/2017. v.\,356, p.\,183--186.

\tit{calo}, Ryan, \textit{Digital Market Manipulation}. 82 George Washington
Law Review 995, 08/2013. n.\,2013--27, p.\,995--2051. Disponível em \textit{hedra.com.br/r/dTp}.

\tit{castells}, M. \textit{A sociedade em rede}. São Paulo: Paz e Terra, 2007.

\tit{daim}, T. U. \textit{et al.} \textit{Forecasting emerging technologies: Use
of bibliometrics and patent analysis}. Technological Forecasting and
Social Change, 10/2006. v.\,73, n.\,8, p.\,981--1012.

\tit{deleuze}, G. \textit{Conversações}. São Paulo: Editora 34, 1992.

\tit{desrosières}, A. \textit{The Politics of Large Numbers: A History of
Statistical Reasoning}. Cambridge: Harvard University Press, 2002.

\tit{donohue}, A. \textit{Augmenting text messages with emotion information}.
Disponível em \textit{hedra.com.br/r/Bbf}.

\tit{dourish}, p.\,\textit{Algorithms and their others: Algorithmic culture in
context}. Big Data \& Society, 12/2016. v.\,3, n.\,2, p.\,1--11.

\tit{foucault}, M. \textit{Historia Da Sexualidade, v.\,2 --- O Uso Dos Prazeres}.
São Paulo: Paz e Terra, 1998.

\titidem. \textit{Vigiar e punir: nascimento da prisão}. Petropolis:
Vozes, 2011.

\titidem. \textit{A Verdade e as Formas Jurídicas}. Edição:
4ª ed. Rio de Janeiro: \textsc{nau}, 2013.

\tit{gillespie}, T. \textit{The politics of `platforms'}. New Media \&
Society, 05/2010. v.\,12, n.\,3, p.\,347--364.

\titidem. \textit{The Relevance of Algorithms}. \textit{In}:
...
\tit{hilbert}, M. \textit{Quantifying the Data Deluge and the Data Drought}.
Rochester, \textsc{ny}: Social Science Research Network, 2015. Disponível em \textit{hedra.com.br/r/iqx}.

\tit{hui}, Y. \textit{Modulation after Control}. New formations: a journal of
culture/theory/politics, 11/2015. v.\,84, n.\,84, p.\,74--91.

\tit{ifi CLAIMS}. 2017 \textit{Top 50 \textsc{us} Patent Assignees}. \textsc{ifi claims}® Patent
Services, 2018. Disponível em \textit{hedra.com.br/r/pwP}.

\tit{introna}, L. D. \textit{Algorithms, Governance, and Governmentality: On
Governing Academic Writing}. Science, Technology, \& Human
Values, 01/2016. v.\,41, n.\,1, p.\,17--49.

\tit{jeong}, S. \textit{Zuckerberg struggles to name a single Facebook
competitor}. The Verge, 04/2018. Disponível em \textit{hedra.com.br/r/pwP}.

\tit{joler}, V.; \textsc{petrovski}, A. \textit{Immaterial Labour and Data Harvesting}.
\textsc{share lab}, 08/2016. Disponível em \textit{hedra.com.br/r/apL}.

\tit{kitchin}, R. \textit{Thinking Critically About and Researching
Algorithms}. Rochester, \textsc{ny}: Social Science Research Network, 2014.
Disponível em \textit{hedra.com.br/r/NVR}.

\titidem. \textit{Thinking critically about and researching
algorithms}. Information, Communication \& Society, 01/2017. v.\,20,
n. 1, p.\,14--29.

\tit{kramer}, Adam; \textsc{guillory}, Jamie; \textsc{hancock}, Jeffrey. \textit{Experimental evidence of massive-scale emotional contagion through social networks}. \textsc{pnas}. vol.\,111. 2014. Disponível em \textit{hedra.com.br/r/tFJ}.

\tit{latour}, B. \textit{Science in Action: How to Follow Scientists and
Engineers Through Society}. Cambridge: Harvard University Press, 1987.

\tit{lazzarato}, M. \textit{As revoluções do capitalismo}. São Paulo: Editora
Record, 2006.

\tit{levy}, p.\,\textit{Cibercultura}. São Paulo: Editora 34, 2010.

\tit{machlup}, F. \textit{The production and distribution of knowledge in the
United States}. Ed. Princeton, \textsc{nj}: Princeton Univ.
Press, 1972.

\tit{mahdawi}, A. \textit{Uber developing technology that would tell if you're
drunk}. The Guardian, 06/2018. Disponível em \textit{hedra.com.br/r/MQg}.

\tit{marinho}, M. H. \textit{O consumidor brasileiro agora é hiper}. Think
with Google, 2014. Disponível em \textit{hedra.com.br/r/Gsc}.

\tit{mortenson}, D. \textit{2017 Year in review: Data centers}. Facebook Code,
2017. Disponível em \textit{hedra.com.br/r/k6X}.

\tit{pariser}, E. \textit{O filtro invisível: O que a Internet está escondendo
de você}. Rio de Janeiro: Zahar, 2012.

\tit{pasquale}, F. \textit{The black box society: the secret algorithms that
control money and information}. Cambridge: Harvard University Press,
2015.

\tit{rieder}, B. \textit{Scrutinizing an algorithmic technique: the Bayes
classifier as interested reading of reality}. Information, Communication
\& Society, 01/2017. v.\,20, n.\,1, p.\,100--117.

\tit{rouvroy}, Antoinette; \textsc{berns}, Thomas. \textit{Governamentalidade
algorítmica e perspectivas de emancipação: o díspar como condição de
individuação pela relação?}. Revista \textsc{eco}-Pós, v.\,18, n.\,2, p.\,36--56, out. 2015. \textsc{issn} 2175--8689. Disponível em \textit{hedra.com.br/r/RoR}.

\tit{sartore}, M. D. S.; \textsc{leite}, E. D. S. \textit{Desconstruindo os
dispositivos dos mercados: aportes da Sociologia Econômica}. Revista
\textsc{tomo}, 06/2017. Disponível em \textit{hedra.com.br/r/AhB}.

\tit{savat}, D. \textit{Deleuze and new technology}. Edinburgh: Edinburgh
University Press, 2009.

\tit{seaver}, n.\,\textit{Algorithms as culture: Some tactics for the
ethnography of algorithmic systems}. Big Data \& Society, 12/2017. v.
4, n.\,2, p.\,2053951717738104.

\tit{silveira}, S. A.; \textsc{avelino}, R.; \textsc{souza}, J. \textit{A privacidade e o
mercado de dados pessoais} (\textit{Privacy and the market of personal
data}). Liinc em Revista, 11/2016. v.\,12, n.\,2. Disponível em \textit{hedra.com.br/r/29i}.

\tit{silveira}, S. A. da. \textit{Tudo sobre tod@s: Redes digitais,
privacidade e venda de dados pessoais}. São Paulo: Edições Sesc, 2017.

\tit{souza}, J.; \textsc{machado}, D.; \textsc{avelino}, R. \textit{Big Data, Vigilância e o
Mercado de Dados Pessoais na Saúde}. Santiago, 2018. p.\,17.

\tit{srnicek}, n.\,\textit{Platform Capitalism}. 1 edition. Cambridge, \textsc{uk}-Malden,
\textsc{ma}: Polity, 2016.

\tit{zuboff}, Shoshana. \textit{Big other: surveillance capitalism and the
prospects of an information civilization.} London: Journal of
Information Technology, 2015, 75--89. Disponível em \textit{hedra.com.br/r/nIP}.
\end{bibliohedra}
...
De acordo com Hazelwood,\footnote{\textit{Op.\,cit.}} o \textit{\textsc{fbl}earner Flow} faz parte do kit de ferramentas que visam alavancar o Aprendizado de Máquina
...
De acordo com Matthew,\footnote{\textit{Id}.} essa história começou quando
...
\tit{biddle}, Sam. \textit{Facebook usa Inteligência Artificial para prever o
comportamento de usuário para anunciantes}. Tradução: Bernardo
Tonasse. 2018. The Intercept\_Brasil. Disponível em \textit{hedra.com.brVEh}.

\tit{borini}, Guilherme. \textit{Facebook investe \textsc{us}\$ 30 milhões para
aquisição de startup de inteligência artificial}. 2018. Disponível em \textit{hedra.com.br/r/A0S}.

\tit{cadwalladr}, Carole. \textit{The Cambridge Analytica Files - `I made
Steve Bannon's psychological warfare tool': meet the data war
whistleblower}. 2018. Disponível em \textit{hedra.com.br/r/kMz}.

\tit{cadwalladr}, Carole e \textsc{graham-harrison}, Emma. \textit{Revealed: 50 million
Facebook profiles harvested for Cambridge Analytica in major data
breach}. 2018. Disponível em \textit{hedra.com.br/r/JXX}.
...
\textsc{guareschi}, Pedrinho A; \textsc{amon}, Denise e \textsc{guerra}, André. \textit{Psicologia,
...
\tit{guareschi}, Pedrinho. Ensaio 5, ``Psicologia e Pós-Verdade''. \textit{In}:
\textsc{guareschi}, Pedrinho A; \textsc{amon}, Denise e \textsc{guerra}, André. \textit{Psicologia,
Comunicação e Pós-verdade}. Porto Alegre: Abrapso, 2017. p.\,161--193.

\tit{haas}, Guilherme. \textit{Google compra DeepMind, startup de programação
em inteligência artificial}. 2014. Disponível em \textit{hedra.com.br/r/P1W}.

\tit{hazelwood}, Kim, \textit{et al}. \textit{Applied Machine Learning at Facebook: A
Datacenter Infrastructure Perspective}. 2018. Disponível em \textit{hedra.com.br/r/4In}.

\tit{júnior}, Gilberto Timótheo e \textsc{lima}, Sérgio Muinhos Barroso.
\textit{Algoritmos Genéticos Aplicados a Jogos Eletrônicos}. Revista
Eletrônica da Faculdade Metodista Granbery, Curso de Sistemas de
Informação, n.\,8. 2010. Disponível em \textit{hedra.com.br/r/asH}.

\tit{kosinski}, Michal, \textsc{stillwella}, David, e \textsc{graepelb}, Thore.
\textit{Private traits and attributes are predictable from digital
records of human behavior}. \textsc{pnas}, vol.\, 110, n.\,15, 04/2013.
Disponível em \textit{hedra.com.br/r/L3a}.

\tit{kosinski}, Michal, \textsc{wang}, Yilun, \textsc{lakkaraju}, Himabindu e \textsc{leskovec}, Jure. \textit{Mining Big Data to Extract Patterns and Predict Real-Life
Outcomes}. Psychological Methods, vol.\, 21, n.\,4, 2016. Disponível em \textit{hedra.com.br/r/FZy}.
...
\tit{matthew}, Rosenberg \textit{et al}. \textit{How Trump Consultants Exploited the
Facebook Data of Millions.} 2018. Disponível em \textit{hedra.com.br/r/IcB}.

\tit{matza}, C, \textsc{kosinski}, M. \textsc{navec}, G. e \textsc{stillwelld}, D. J.
\textit{Psychological Targeting as an Effective Approach to Digital Mass
Persuasion}. \textsc{pnas}, vol.\, 114, n.\,48, 28 nov. 2017. Disponível em \textit{hedra.com.br/r/Qbi}.

\tit{mcculloch}, Warren S. e \textsc{pitts}, Walter. \textit{A logical calculus of the
ideas immanent in nervous activity}. Bulletin of Mathematical
Biophysics, vol.\,5. 1943. Disponível em \textit{hedra.com.br/r/neP}.

\tit{moreira}, Daniel. \textit{O que é uma startup?} 2018. Disponível em \textit{hedra.com.br/r/hrs}.
...
\tit{searle}, John R. \textit{Minds, brains, and programs.} The Behavioral and
...
\tit{sugomori}, Yusuke. \textit{Java Deep Learning Essentials.} Packt
Publishing: Birmingham. 2016.

\tit{turing}, A. M. \textit{Computing Machinery and Intelligence}. Mind, v.
59, n.\,236, p.\,433--460, 10/1950. Disponível em \textit{hedra.com.br/r/xnD}.

\tit{vinge}, Vernor. \textit{The coming technological singularity: How to
...
\textit{Computer-based personality judgments are more accurate than
those made by humans.} \textsc{pnas}, v.\,112, n.\,4, 01/2014. Disponível em \textit{hedra.com.br/r/MtK}.
\end{bibliohedra}
...
\textit{apud} Domenico Uhng Hur. \textit{Da biopolítica à noopolítica: Contribuições de Deleuze.} \textsc{lugar comum}, 2012, pp.\,201--215.} A essa axiomática se confere a
...
Simondon\footnote{\textit{Id}.} compara a modulação na psicologia social
...
Matza, Navec, Kosinski e Stillwell\footnote{\textit{Id}.} apontam ainda que o acesso a
...
\textsc{stillwell}, David. \textit{Manifestations of user personality in website
...
\textit{Introduction to Algorithms}, 3rd edition, \textsc{mit} Press, 2009
(\textless{}\textit{https://bit.ly/2UJxjZL}).

\tit{deleuze}, Giles. \textit{Conversações}. Tradução Peter Pál Pelbart. São Paulo: Ed. 34, 1972/\,1990.

\titidem. \textit{Postscript on the society of control.} October,
vol.\, 59. (Winter, 1992), pp.\,3--7.

\tit{DELEUZE}, Gilles \& \textsc{guattari}, Félix. \textit{Mil Platôs: Capitalismo e
Esquizofrenia}, vol.\, 5. São Paulo: 34, 1997 (1980).

\titidem. \textit{O Anti-Édipo.} São Paulo: 34, 2010 (1972).

\tit{foucault}, Michel. \textit{Arqueologia do saber.}~Rio de Janeiro:
Forense, 2008.

\titidem.~\textit{Em Defesa da Sociedade}.~São Paulo: Martins
Fontes, 1999.

\titidem. \textit{Microfísica~do Poder.} 11ª ed., Rio de
Janeiro: Graal, 1997.

\titidem.~\textit{O nascimento da Biopolítica.}~São Paulo:
Martins Fontes, 2008.

\tit{GORZ}, André. \textit{O Imaterial: Conhecimento, Valor e Capital}. São
Paulo, Editora Annablume, 2005.

\tit{HUI}, Yuk. \textit{Modulation after Control. New formations: a journal of
culture/theory/politics}, Volume 84--85, 2015. pp.\,74--91 (Article).
Published by Lawrence \& Wishart.

\tit{KOSINSKI}, Michal. \textsc{stillwell}, David. \textsc{youyou}, Wu. \textit{Computer-based
personality judgments are more accurate than those made by
...
\tit{KOSINSKI}, Michal. \textsc{wang}, Yilun. \textit{Deep neural networks are more
...
\tit{LARIVIÈRE}, Jason. \textit{Logic of digital worlds. Yuk Hui, on the
existence of digital objects.} University of Minnesota Press, 2016.
Parrhesia 27 • 2017 • 129--135.

\tit{MATZA}, S.C. \textsc{navec}, G. \textsc{kosinsky}, M. \textsc{stillwell}, D.J. \textit{Psychological targeting as an effective approach to digital mass persuasion.} Columbia
...
\tit{MARX}, Karl. \textit{O Capital}, Livro I, volume I. São Paulo: Nova
Cultural, 1988.
...
\textit{Psiquiatria, Saúde Mental e Biopoder: Vida, Controle e Modulação
no Contemporâneo.} Psicologia em Estudo, vol.\, 14, n.\,2, 04--06/2009, pp.\,267--275. Universidade Estadual de Maringá. Maringá, Brasil.

\tit{ROSE}, Nikolas. \textit{Psicologia como uma Ciência Social.} Psicologia
\& Sociedade, vol.\,20, n.\,2, 05--08/2008, pp.\,155--164.
...
forme et d'information.} Editions Jérôme Millon, Paris 2005, p.\,91.
Hereafter \textsc{ilfi}.

\tit{TRAVERSO-YÉPEZ}, Martha. \textit{Os discursos e a dimensão simbólica: uma
...
\tit{UHNG HUR}, Domenico. \textit{Da biopolítica à noopolítica: Contribuições de Deleuze.} \textsc{lugar comum} n.\,40, pp.\,201--215.

\tit{WARD}, John William. \textit{Review of The Self-Made Man in America:
...
\begin{bibliohedra}
\tit{alves}, Paulo. \textit{Big Data: o segredo por trás da eleição de Trump}. 2017. Disponível em \textit{hedra.com.br/r/sLD}.

\tit{araújo}, Rafael de Paula Aguiar; \textsc{penteado}, Cláudio Luis Camargo; \textsc{santos},
Marcelo Burgos Pimentel dos. \textit{Democracia digital e experiência de
e-participação: webativismo e políticas públicas}. História, Ciências,
Saúde --- Manguinhos, Rio de Janeiro, v.\,22, supl., 12/2015,
p.\,1597--1619.

\tit{bauman}, Zygmunt. \textit{Modernidade líquida}. Rio de Janeiro: Jorge Zahar, 2001.
...
\tit{brasil}. Constituição (1988). \textit{Constituição da República
Federativa do Brasil}. Disponível em \textit{hedra.com.br/r/fYi}.

\tit{bourdieu}, P.~\textit{O poder simbólico}. Rio de Janeiro: Bertrand Brasil
\textsc{s.\,a.}, 1989.
...
\tit{deleuze}, Gilles. \textit{Post-scriptum Sobre as Sociedades de controle}. \textit{In}: \textsc{deleuze}, Gilles. \textit{Conversações}. São Paulo: Ed. 34, 1990.

\tit{foucault}, Michel. \textit{História da Sexualidade I: A vontade de
saber}. Rio de Janeiro: Edições Graal, 2001.

\titidem.~\textit{Vigiar e punir}. Rio de Janeiro: Editora Vozes, 2004.

\tit{gohn}, Maria da Glória. \textit{Movimentos sociais na contemporaneidade}.
\textit{In}: Revista Brasileira de Educação, v.\,16, n.\,47. 05--08/2011.

\tit{Internetlab}, Site oficial. \textit{InternetLab: Pesquisa em direito e
tecnologia}. Disponível em \textit{hedra.com.br/r/jUv}.

\tit{Internetlab}, Facebook. \textit{Post campanha \#PerguntePorque}.
Disponível em \textit{hedra.com.br/r/H7D}.

\tit{irpc}, Site oficial. \textit{The Internet Rights and Principles Dynamic
Coalition.} Disponível em \textit{hedra.com.br/r/5hP}.

\titidem. \textit{Carta de Direitos Humanos e Princípios para
a Internet.} Disponível em \textit{hedra.com.br/r/5hP}.

\tit{lablivre}, Site Oficial. \textit{Laboratório de Tecnologias Livres da
Universidade Federal do \textsc{abc}}. Disponível em \textit{hedra.com.br/r/Bs1}.

\tit{latour}, Bruno. \textit{Networks, societies, spheres: Reflections of an
actor-network theorist}. \textit{In}: \textit{International Seminar On Network Theory:
...
\tit{mauss}, Marcel. \textit{Sociologia e Antropologia}. São Paulo: Cosac
Naify, 2003.

\tit{menezes}, Marilda A. de. \textit{O cotidiano camponês e a sua importância enquanto
resistência à dominação: a contribuição de James C. Scott}. \textit{In}:
\textit{Raízes}, vol.\, 21, n.\,1, 01--06/2002.

\tit{mian}, Mariella Batarra; \textsc{zotelli}, Gabriel Perrenoud. \textit{Ações
...
\tit{pais, el}. \textit{Caso Cambridge Analytica.} Disponível em \textit{hedra.com.br/r/3L4}.

\tit{rainle}, Lee; \textsc{wellman}, Barry. \textit{Networked: The new social
operating system}. Cambridge: The \textsc{mit} Press, 2012.

\tit{scott}, James C. \textit{Formas cotidianas da resistência camponesa}. \textit{In}:
\textit{Raízes}, vol.\, 21, n.\,01, 01--06/2002.

\titidem. \textit{Los dominados y el arte de la resistência}.
México: Ediciones Era, 1990.

\tit{silveira}, Sério Amadeu da. \textit{A lei de proteção de dados aprovada
por Temer é capenga.} Disponível em \textit{hedra.com.br/r/9VH}.

\chapter*{Modulação \emph{deleuzeana}, modulação algorítmica e~manipulação midiática}

\addcontentsline{toc}{chapter}{Modulação \emph{deleuzeana}, modulação algorítmica e~manipulação midiática, \scriptsize{por João Francisco Cassino}}
...
ou máquinas de modular e cristalizar pacotes de bits [\ldots{}]\footnote{2006, p.\,85.}
\end{quote}
...
cérebros, constituindo hábitos sobretudo na memória mental.\footnote{2006, p.\,86.}
\end{quote}
...
enquadramento emocional, o \emph{framing}, e de imposição de temas na
...
\section{Modulação \emph{deleuzeana}, modulação algorítmica e~manipulação}
...
\emph{site} da Globo,\footnote{Ver \emph{memoriaglobo.globo.com}.} a própria emissora admite que:
...
online que tentam reproduzir a lógica do \emph{Agenda-"setting} e
...
como elas ocorreram e quem as realizou.\footnote{Nick Srnicek, 2017.} O Big Data
...
\emph{Agenda"-setting theory}\footnote{A \emph{Agenda"-setting theory}, de
  ...
  sociedade e fazê"-la pensar sobre um determinado assunto (McCombs, 2009).}, trabalham com a produção do discurso, principalmente, das narrativas. A manipulação se dá
...
estratégicas.\footnote{Castells, 2009, p.\,76.}
\end{quote}
...
de 2013, com o número \textsc{us--9928462b2}, permite obter informações
...
para determinar o estado mental do usuário (\textsc{us--9928462b2}).\footnote{Tradução livre de: \emph{An apparatus for
...
%Foucault (2008)
A lógica da concorrência foi apontada por Foucault como a lógica
...
\caption{\formular\footnotesize{Print com alguns comentários na postagem da página do InternetLab para a campanha \#PerguntePorque.}}\footnote{InternetLab, 2018.}
 \end{figure}
